...
@NonNullApi
public class KMPCheotProProjectDependency extends DelegatingProjectDependency {

    @Inject
    public KMPCheotProProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
